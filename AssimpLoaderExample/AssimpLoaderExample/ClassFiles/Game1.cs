...
namespace AssimpLoaderExample
{
    ...
    public class Game1 : Game
    {
        ...
        Vector3 LightPosition = new Vector3(0f, 100f, 200f);
        ...
        protected override void LoadContent()
        {
            ...
            //model = modelReader.LoadAsset("IA_test.fbx", 24);
            //model = modelReader.LoadAsset("Gun_Bot.fbx", 24); // damn its hard to find models that work.
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (model != null)
            {
                riggedEffect.Parameters["World"].SetValue(Matrix.Identity);
                riggedEffect.Parameters["View"].SetValue(cam.View);
                riggedEffect.Parameters["CameraPosition"].SetValue(cam.Position);
